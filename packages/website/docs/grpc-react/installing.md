...
`npm install @nixjs/grpc-core @nixjs/grpc-react`

## 🚀 Install with yarn

`yarn add @nixjs/grpc-core @nixjs/grpc-react`
...
import { GRPCProvider, ClientServiceSourceProps } from '@nixjs/grpc-react'
...
import { useGRPC } from '@nixjs/grpc-react'
